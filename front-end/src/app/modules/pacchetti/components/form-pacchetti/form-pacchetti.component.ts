...
@Component({
  selector: 'app-form-pacchetti',
  templateUrl: './form-pacchetti.component.html',
  styleUrl: './form-pacchetti.component.css',
  standalone: true,
  imports: [CommonModule, FormsModule, ReactiveFormsModule],
})
export class FormPacchettiComponent implements OnInit {
  ...
  ngOnInit() {
    console.log('FormPacchettiComponent ngOnInit, dati:', this.dati);

...
export const PACCHETTI_COLUMNS: IColumnDef[] = [
...
export const PACCHETTI_AZIONI: IAzioneDef[] = [
  {
    label: 'Modifica',
    icon: 'fa fa-pen',
...
export const PACCHETTI_FILTRI: IFiltroDef[] = [
  {
    key: 'nome',
    label: 'Nome',
    type: 'text',
...
export const PACCHETTI_AZIONI_PAGINA: 
ButtonConfig[] = [
  {
      text: 'Filtri',
      icon: 'fas fa-filter',
